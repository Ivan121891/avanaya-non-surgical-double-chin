(function () {
  ...
  // ------- Configuration -------
  const SERVICE_NAME = "Non-Surgical Double Chin";
  const SERVICE_DURATION_MIN = 60;

  // GHL credentials
  const GHL = {
    locationId: 'SQpwKCPhe2vgUlNkn9eb',
    calendarId: 'qOtRmmqgaKMo95DjXmI2',
    userId:     '2tQreqXcDpaAiSBqlK7T',
    apiKey:     'pit-a5128812-6193-42cd-8a6b-7889bc757698',
  ...
  detailsForm.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      const contactRes = await ghlFetch('/contacts/upsert', {
        ...
        email,
        phone,
        source: 'Non-Surgical Double Chin LP',
        tags: ['Non-Surgical Double Chin'],
      });
      ...
      await ghlFetch('/calendars/events/appointments', {
        ...
        title:          `${name} — Non-Surgical Double Chin`,
